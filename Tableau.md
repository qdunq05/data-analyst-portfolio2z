...
Dashboard phân tích doanh thu theo khu vực, sản phẩm, kênh bán hàng và thời gian.
...
- Xử lý và kiểm tra dữ liệu doanh thu (data validation) trước khi trực quan hóa
- Xây dựng KPI Dashboard với Filter và Dashboard Actions
- Phân tích số liệu và đưa ra nhận định về hiệu suất kinh doanh

## Xem dashboard trực tiếp (tương tác)

🔗 [Xem trên Tableau Public]([dán-link-tableau-public-của-bạn-vào-đây](https://public.tableau.com/views/PHNTCHLINHUNVDBO/Story2?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link))
...
<img width="1917" height="1078" alt="Screenshot 2026-07-18 223424" src="https://github.com/user-attachments/assets/fe551303-9ec1-4934-b919-c7520d7b44b7" />
